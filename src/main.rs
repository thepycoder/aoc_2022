...
fn main() -> io::Result<()> {
    ...
    if days.contains(&20) {
        let total = day20::day20_1("data/input20_1.txt");
        println!("Day 20 Part 1: {}", total.unwrap());

        let total = day20::day20_2("data/input20_1.txt");
        println!("Day 20 Part 2: {}", total.unwrap());
    }
